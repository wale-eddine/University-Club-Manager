...
function resolvePostDeleteRedirect($from, $redirectBack, $currentHost, $club_id) {
    ...
    if (preg_match('~/php/dashboard\.php$~i', $path)) {
        return '../dashboard.php';
    }
    if (preg_match('~/php/requests\.php$~i', $path)) {
        return '../requests.php';
    }
    if (preg_match('~/php/event_php/events\.php$~i', $path)) {
        return '../event_php/events.php';
    }
    if (preg_match('~/php/club_php/clubs\.php$~i', $path)) {
        return 'clubs.php';
    }
    if (preg_match('~/php/club_php/club_detail\.php$~i', $path)) {
        $query = [];
